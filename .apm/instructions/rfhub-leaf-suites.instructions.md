...
- `__init__.robot` holds shared `Force Tags`, Documentation, and Resource imports for that folder. Tests live in sibling `.robot` files, not only in `__init__.robot`.
